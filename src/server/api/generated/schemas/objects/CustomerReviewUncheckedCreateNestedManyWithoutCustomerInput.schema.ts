...
const Schema: z.ZodType<Prisma.CustomerReviewUncheckedCreateNestedManyWithoutCustomerInput> =
  z
    .object({
      create: z
        .union([
...
export const CustomerReviewUncheckedCreateNestedManyWithoutCustomerInputObjectSchema =
  Schema;
