...
const Schema: z.ZodType<Prisma.MetaDataUncheckedCreateNestedManyWithoutCategoryInput> =
  z
    .object({
      create: z
        .union([
...
export const MetaDataUncheckedCreateNestedManyWithoutCategoryInputObjectSchema =
  Schema;
