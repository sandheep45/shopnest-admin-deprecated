...
const Schema: z.ZodType<Prisma.CustomerReviewUncheckedUpdateManyWithoutProductNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const CustomerReviewUncheckedUpdateManyWithoutProductNestedInputObjectSchema =
  Schema;
