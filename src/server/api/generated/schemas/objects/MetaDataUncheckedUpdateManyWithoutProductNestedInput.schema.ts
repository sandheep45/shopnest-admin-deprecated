...
const Schema: z.ZodType<Prisma.MetaDataUncheckedUpdateManyWithoutProductNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const MetaDataUncheckedUpdateManyWithoutProductNestedInputObjectSchema =
  Schema;
