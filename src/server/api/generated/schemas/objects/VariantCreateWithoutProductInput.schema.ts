...
import { MetaDataCreateNestedManyWithoutVariantInputObjectSchema } from "./MetaDataCreateNestedManyWithoutVariantInput.schema";

import type { Prisma } from "@prisma/client";

const Schema: z.ZodType<Prisma.VariantCreateWithoutProductInput> = z
  .object({
    ...
    MetaData: z
      .lazy(() => MetaDataCreateNestedManyWithoutVariantInputObjectSchema)
      .optional(),
  })
  .strict();

export const VariantCreateWithoutProductInputObjectSchema = Schema;
