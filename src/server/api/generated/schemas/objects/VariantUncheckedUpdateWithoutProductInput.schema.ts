...
import { MetaDataUncheckedUpdateManyWithoutVariantNestedInputObjectSchema } from "./MetaDataUncheckedUpdateManyWithoutVariantNestedInput.schema";

import type { Prisma } from "@prisma/client";

const Schema: z.ZodType<Prisma.VariantUncheckedUpdateWithoutProductInput> = z
  .object({
    name: z
      .union([
        z.string(),
    ...
    MetaData: z
      .lazy(
        () => MetaDataUncheckedUpdateManyWithoutVariantNestedInputObjectSchema
      )
      .optional(),
  })
  .strict();

export const VariantUncheckedUpdateWithoutProductInputObjectSchema = Schema;
