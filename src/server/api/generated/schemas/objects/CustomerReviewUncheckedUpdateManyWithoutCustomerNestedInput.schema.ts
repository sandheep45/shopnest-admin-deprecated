...
const Schema: z.ZodType<Prisma.CustomerReviewUncheckedUpdateManyWithoutCustomerNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const CustomerReviewUncheckedUpdateManyWithoutCustomerNestedInputObjectSchema =
  Schema;
