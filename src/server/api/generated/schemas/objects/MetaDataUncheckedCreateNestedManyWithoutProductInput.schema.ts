...
const Schema: z.ZodType<Prisma.MetaDataUncheckedCreateNestedManyWithoutProductInput> =
  z
    .object({
      create: z
        .union([
...
export const MetaDataUncheckedCreateNestedManyWithoutProductInputObjectSchema =
  Schema;
