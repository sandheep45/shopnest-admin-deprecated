...
const Schema: z.ZodType<Prisma.CategoryUncheckedUpdateWithoutMetaDataInput> = z
  .object({
    name: z
      .union([
        z.string(),
...
export const CategoryUncheckedUpdateWithoutMetaDataInputObjectSchema = Schema;
