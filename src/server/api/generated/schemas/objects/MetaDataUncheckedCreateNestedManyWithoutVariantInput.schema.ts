...
const Schema: z.ZodType<Prisma.MetaDataUncheckedCreateNestedManyWithoutVariantInput> =
  z
    .object({
      create: z
        .union([
...
export const MetaDataUncheckedCreateNestedManyWithoutVariantInputObjectSchema =
  Schema;
