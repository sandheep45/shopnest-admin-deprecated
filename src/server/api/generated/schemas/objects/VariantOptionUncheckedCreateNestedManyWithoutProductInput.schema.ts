...
const Schema: z.ZodType<Prisma.VariantOptionUncheckedCreateNestedManyWithoutProductInput> =
  z
    .object({
      create: z
        .union([
...
export const VariantOptionUncheckedCreateNestedManyWithoutProductInputObjectSchema =
  Schema;
