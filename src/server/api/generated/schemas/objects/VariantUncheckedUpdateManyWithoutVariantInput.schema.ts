...
const Schema: z.ZodType<Prisma.VariantUncheckedUpdateManyWithoutVariantInput> =
  z
    .object({
      name: z
        .union([
...
export const VariantUncheckedUpdateManyWithoutVariantInputObjectSchema = Schema;
