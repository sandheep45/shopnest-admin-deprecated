...
const Schema: z.ZodType<Prisma.MetaDataUpdateManyWithoutCategoryNestedInput> = z
  .object({
    create: z
      .union([
...
export const MetaDataUpdateManyWithoutCategoryNestedInputObjectSchema = Schema;
