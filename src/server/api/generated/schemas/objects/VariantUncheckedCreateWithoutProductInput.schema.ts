...
import { MetaDataUncheckedCreateNestedManyWithoutVariantInputObjectSchema } from "./MetaDataUncheckedCreateNestedManyWithoutVariantInput.schema";

import type { Prisma } from "@prisma/client";

const Schema: z.ZodType<Prisma.VariantUncheckedCreateWithoutProductInput> = z
  .object({
    ...
    MetaData: z
      .lazy(
        () => MetaDataUncheckedCreateNestedManyWithoutVariantInputObjectSchema
      )
      .optional(),
  })
  .strict();

export const VariantUncheckedCreateWithoutProductInputObjectSchema = Schema;
