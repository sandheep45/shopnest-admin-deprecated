...
const Schema: z.ZodType<Prisma.ProductUncheckedUpdateWithoutCustomerReviewInput> =
  z
    .object({
      name: z
        .union([
...
export const ProductUncheckedUpdateWithoutCustomerReviewInputObjectSchema =
  Schema;
