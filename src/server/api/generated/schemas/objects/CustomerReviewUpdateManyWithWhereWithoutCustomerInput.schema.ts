...
const Schema: z.ZodType<Prisma.CustomerReviewUpdateManyWithWhereWithoutCustomerInput> =
  z
    .object({
...
export const CustomerReviewUpdateManyWithWhereWithoutCustomerInputObjectSchema =
  Schema;
