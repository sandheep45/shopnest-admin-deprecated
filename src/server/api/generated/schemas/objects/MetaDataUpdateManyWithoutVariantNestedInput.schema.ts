...
const Schema: z.ZodType<Prisma.MetaDataUpdateManyWithoutVariantNestedInput> = z
  .object({
    create: z
      .union([
...
export const MetaDataUpdateManyWithoutVariantNestedInputObjectSchema = Schema;
