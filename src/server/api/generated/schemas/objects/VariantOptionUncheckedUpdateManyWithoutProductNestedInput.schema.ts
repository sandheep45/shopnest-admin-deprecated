...
const Schema: z.ZodType<Prisma.VariantOptionUncheckedUpdateManyWithoutProductNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const VariantOptionUncheckedUpdateManyWithoutProductNestedInputObjectSchema =
  Schema;
