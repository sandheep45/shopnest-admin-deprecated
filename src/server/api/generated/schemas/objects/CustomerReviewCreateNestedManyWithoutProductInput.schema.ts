...
const Schema: z.ZodType<Prisma.CustomerReviewCreateNestedManyWithoutProductInput> =
  z
    .object({
      create: z
        .union([
...
export const CustomerReviewCreateNestedManyWithoutProductInputObjectSchema =
  Schema;
