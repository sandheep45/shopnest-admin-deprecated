...
import { MetaDataUpdateManyWithoutVariantNestedInputObjectSchema } from "./MetaDataUpdateManyWithoutVariantNestedInput.schema";
import { ProductUpdateOneRequiredWithoutVariantNestedInputObjectSchema } from "./ProductUpdateOneRequiredWithoutVariantNestedInput.schema";

import type { Prisma } from "@prisma/client";

const Schema: z.ZodType<Prisma.VariantUpdateInput> = z
  .object({
    name: z
      .union([
        z.string(),
    ...
    updatedAt: z
      ...
      .optional(),
    MetaData: z
      .lazy(() => MetaDataUpdateManyWithoutVariantNestedInputObjectSchema)
      .optional(),
    product: z
      .lazy(() => ProductUpdateOneRequiredWithoutVariantNestedInputObjectSchema)
      .optional(),
  })
  .strict();

export const VariantUpdateInputObjectSchema = Schema;
