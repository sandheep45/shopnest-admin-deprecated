            ...
            <div className="flex items-center justify-center lg:col-span-3">
              <div className="flex w-[90%] flex-col items-center justify-center gap-10 md:w-[55%]">
                ...
                <div className="flex w-full flex-col gap-4">
                  ...
                  <div className="flex w-full flex-col gap-3">
                    <button
                      ...
                      className="flex items-center justify-center gap-2 rounded-sm border border-gray-300 bg-gray-100 py-1.5 text-sm font-medium transition-all duration-500 hover:bg-gray-200"
                    >
                ...
                <div className="flex w-full flex-col gap-1">
                  ...
                  <Link
                    href="/signup"
                    className="bg-white py-2 text-sm font-semibold text-blue-600"
                  >
                    Create an Account
                  </Link>
                </div>
