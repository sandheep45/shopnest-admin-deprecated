...
export interface CompleteCustomerReview extends z.infer<typeof CustomerReviewModel> {
 ...
 */
export const RelatedCustomerReviewModel: z.ZodSchema<CompleteCustomerReview> = z.lazy(() => CustomerReviewModel.extend({
